// cart info will be stored in userSession
...
class Cart {
  ...
  addItem(product) {
    //args is instance of Product class
    // if items already in cart, then increment its count
